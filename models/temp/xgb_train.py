...
def train_and_save_model(pickle_path, save_base):
    ...
    print_step("Training XGBoost model")
    model = XGBRegressor(
    ...
    plot_and_save_violin(y_test_actual, y_test_pred, "Flood Depth (m)", os.path.join(save_base, "violin_test.png"), title="XGBoost prediction vs Flood Depth (test set)")
